...
//*********************************************************
// METODO ENCARGADO DE AUMENTAR EL TAMANO DEL VECTOR, SI EL 
...
//********************************************	  
    ...
    public void insertarTermino(int coe, int exp, int tipe){   
        
        switch (tipe) {
            case 1:
                InsertarPolinomioForma1(coe, exp);
                break;
            case 2:
                InsertarPolinomioForma2(coe, exp);
                break;
    ...
    public void InsertarPolinomioForma1(int coe, int exp){
        if (exp > vec[0]) {
            int aux[];
            aux = new int[exp + 2];
            ...
            int pos = vec2[0] + 1 - exp;
            vec2[pos] = vec2[pos] + coe;
            //ajustar();
        }
    }
    
    public void InsertarPolinomioForma2(int coe , int exp){
        int i =1;
